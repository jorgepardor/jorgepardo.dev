    ...
    <div className="container mx-auto">
      <div className="flex items-center justify-center mx-14 py-14">
        <div className="container">
          <div className="row">
            <img src="https://res.cloudinary.com/jorgepardor/image/upload/v1661334441/jorgepardo.dev/design/lexquisiteespa%C3%B1a/a762d1110641393.5ff2fe0b946d4_result_y3ytdk.webp" />
