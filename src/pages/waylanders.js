...
export const Waylanders = () => {
  return (
    <section className=" bg-TW-bg-dark h-screen">
      <div className="flex items-center pt-16 pb-4">
        <img
          className="w-1/6 m-auto"
          src="https://res.cloudinary.com/jorgepardor/image/upload/v1659882606/jorgepardo.dev/waylanders/logo_waylanders_White_cejixe.webp" alt="The Waylanders logo"
        />
      </div>
